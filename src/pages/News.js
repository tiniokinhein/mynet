...
import { NEWS, NEWS_BG } from '../config/api'
        ...
        <>
            <Helmet
                ...
                meta={[
                    {
                        name: 'description',
                        content: 'Our news are up to date.'
                    },
                    {
                        property: 'og:description',
                        content: 'Our news are up to date.'
                    },
                    { property: 'og:title', content: t('site.blog') + ' || myneT Solutions' },
                    ...
                    { property: 'twitter:title', content: t('site.blog') + ' || myneT Solutions' },
                    { property: 'twitter:description', content: 'Our news are up to date.' }
                ]}
            >
